...
export const videoFormats: VideoFormat[] = [
  ...
  { id: 'cinematic', label: 'Cinema', width: 1920, height: 1080, ratio: '16/9', frame: { innerRatio: 16/9, padding: 0.02, radius: 28 } },
  { id: 'framed', label: 'Frame', width: 1080, height: 1920, ratio: '9/16', frame: { innerRatio: 3/4, padding: 0.02, radius: 28 } },
];
